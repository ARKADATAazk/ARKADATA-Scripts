...
function M.PushMyStyle(ctx)
  ...
  ImGui.PushStyleColor(ctx, ImGui.Col_ScrollbarBg,               0x00000000)  -- Transparent background
  ImGui.PushStyleColor(ctx, ImGui.Col_ScrollbarGrab,             0x4A4A4AFF)  -- Thumb color
  ImGui.PushStyleColor(ctx, ImGui.Col_ScrollbarGrabHovered,      0x5A5A5AFF)  -- Thumb hover
  ImGui.PushStyleColor(ctx, ImGui.Col_ScrollbarGrabActive,       0x6A6A6AFF)  -- Thumb active/dragging
